...
export default function PaywallFaq() {
  ...
  return (
    <div className="w-[600px] flex flex-col items-start gap-[20px]">
      ...
      <div className="w-full min-w-[480px] h-[468px] flex flex-col items-start gap-[16px]">
        {items.map((it, i) => {
              ...
              >
                ...
                <div className="relative w-[24px] h-[24px] shrink-0 mt-[2px]">
                  <Image
                    src={
                      open
                        ? "/assets/paywall/faq-minus.png"
                        : "/assets/paywall/faq-plus.png"
                    }
                    alt=""
                    fill

...
const gameBlocks = [
  { top: "/assets/game-pg-2.png", bottom: "/assets/game-pg-2.png", type: "a" },
  { top: "/assets/game-pg-1.png", bottom: "/assets/game-pg-1.png", type: "b" },
  { top: "/assets/game-pg-3.png", bottom: "/assets/game-pg-3.png", type: "c" },
  { top: "/assets/game-pg-1.png", bottom: "/assets/game-pg-1.png", type: "a" },
  { top: "/assets/game-pg-2.png", bottom: "/assets/game-pg-2.png", type: "b" },
  { top: "/assets/game-pg-3.png", bottom: "/assets/game-pg-3.png", type: "c" },
  { top: "/assets/game-pg-2.png", bottom: "/assets/game-pg-2.png", type: "a" },
  { top: "/assets/game-pg-1.png", bottom: "/assets/game-pg-1.png", type: "b" },
  { top: "/assets/game-pg-3.png", bottom: "/assets/game-pg-3.png", type: "c" },
...
const duplicatedBlocks = [...gameBlocks, ...gameBlocks];
  ...
  return (
    <div className="relative w-[156px] h-[52px] shrink-0">
      ...
      <div className="absolute left-[69px] top-0 flex items-center gap-[4px]">
        ...
        <span className="text-[#f04438] font-semibold text-[14px] font-[family-name:var(--font-inter)]">
          110 ms
        </span>
      </div>
      <div className="absolute left-[69px] top-[28px] flex items-center gap-[4px]">
        ...
        <span className="text-[#17b26a] font-semibold text-[20px] font-[family-name:var(--font-inter)]">
          47 ms
        </span>
      </div>
    </div>
